<template>
    <Dialog v-model:visible="visible" modal header="Editar resultado de etapa" class="w-full md:w-2/3 lg:w-1/2 m-2">
        <RallyStageResultEditForm
            v-if="rallyStageResult?.id"
            :rallyStageResult="rallyStageResult"
            @updated="onUpdated"
            @close="closeModal" />
...
import RallyStageResultEditForm from './RallyStageResultEditForm.vue'
