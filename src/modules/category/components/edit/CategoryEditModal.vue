<template>
    <Dialog v-model:visible="visible" modal header="Editar categoria" class="w-full md:w-2/3 lg:w-1/2 m-2">
        <CategoryEditForm v-if="category?.id" :category="category" @updated="onUpdated" @close="closeModal" />
