...
export const useGetDepartmentAssociations = ({ onError } = {}) => {
    ...
    const get = async (query = {}) => {
        try {
            loading.value = true
            const response = await DepartmentAssociationService.get(query)
            departmentAssociations.value = response.data.data
